...
First we will establish a connection to the file
Then the program will read the file in a loop
Then we will close the file
There will be 3 functions, the first will display the number of grades
The second will display the average grade
The third will display the percentage of grades above the average grade
"""
